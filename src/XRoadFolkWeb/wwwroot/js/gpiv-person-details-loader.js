...
(function(){
  ...
  async function loadPerson(publicId,sourceEl){
    ...
    try {
      ...
      clearPanel(); var builder2=(window._renderPairsGroupedForPerson||defaultRenderPairsGrouped); var acc=builder2(details); if(acc&&els.body){ acc.classList.add('pd-fade-in'); els.body.appendChild(acc); } else showInfo('No details to display.');
